...
// Import your new SearchBarComponent
...
@Component({
  selector: 'app-header',
  standalone: true,
  imports: [CommonModule, RouterLink, SearchBarComponent, ...MATERIAL_MODULES],
...
export class HeaderComponent implements OnInit, OnDestroy {
  ...
  // This gets triggered when SearchBarComponent emits a result
